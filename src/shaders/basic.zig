...
//    void main()
//    {
//        gl_Position = ((mat4(vs_params[0], vs_params[1], vs_params[2], vs_params[3]) * mat4(vs_params[4], vs_params[5], vs_params[6], vs_params[7])) * mat4(vs_params[8], vs_params[9], vs_params[10], vs_params[11])) * vec4(position, 0.0, 1.0);
//        vec2 _51 = texture0 * vs_params[12].zw;
//        uv = _51 + vs_params[12].xy;
//        uv = _51 + (vs_params[12].xy * vs_params[12].zw);
//    }
//
//
const vs_source_glsl410 = [543]u8 {
    ...
    0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x3b,0x0a,0x0a,0x76,0x6f,0x69,0x64,0x20,
    ...
    0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x31,0x5d,0x29,0x29,0x20,0x2a,0x20,0x76,0x65,
    ...
    0x20,0x5f,0x35,0x31,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x20,
    0x2a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x32,0x5d,0x2e,
    0x7a,0x77,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x5f,0x35,0x31,
    0x20,0x2b,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x32,0x5d,
    0x2e,0x78,0x79,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x5f,0x35,
    0x31,0x20,0x2b,0x20,0x28,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,
    0x32,0x5d,0x2e,0x78,0x79,0x20,0x2a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,
    0x73,0x5b,0x31,0x32,0x5d,0x2e,0x7a,0x77,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 410
//
...
//
//
const vs_source_glsl300es = [525]u8 {
    ...
    0x61,0x6d,0x73,0x5b,0x31,0x31,0x5d,0x29,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,
    ...
    0x35,0x31,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x20,0x2a,0x20,
    0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x32,0x5d,0x2e,0x7a,0x77,
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x5f,0x35,0x31,0x20,0x2b,
    0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x32,0x5d,0x2e,0x78,
    0x79,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x5f,0x35,0x31,0x20,
    0x2b,0x20,0x28,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x32,0x5d,
    0x2e,0x78,0x79,0x20,0x2a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,
    0x31,0x32,0x5d,0x2e,0x7a,0x77,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 300 es
...
//    {
//        row_major float4x4 _20_model : packoffset(c0);
//        row_major float4x4 _20_view : packoffset(c4);
//        row_major float4x4 _20_projection : packoffset(c8);
//        float2 _20_uv_offset : packoffset(c12);
//        float2 _20_uv_scale : packoffset(c12.z);
//    };
//
//
...
//    void vert_main()
//    {
//        gl_Position = mul(float4(position, 0.0f, 1.0f), mul(_20_projection, mul(_20_view, _20_model)));
//        float2 _51 = texture0 * _20_uv_scale;
//        uv = _51 + _20_uv_offset;
//        uv = _51 + (_20_uv_offset * _20_uv_scale);
//    }
//
...
const vs_source_hlsl4 = [1098]u8 {
    ...
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x5f,0x32,0x30,0x5f,0x6d,0x6f,
    ...
    0x6a,0x6f,0x72,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x5f,0x32,0x30,
    ...
    0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x20,0x5f,0x32,0x30,0x5f,0x75,
    0x76,0x5f,0x6f,0x66,0x66,0x73,0x65,0x74,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,
    0x66,0x66,0x73,0x65,0x74,0x28,0x63,0x31,0x32,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,
    0x66,0x6c,0x6f,0x61,0x74,0x32,0x20,0x5f,0x32,0x30,0x5f,0x75,0x76,0x5f,0x73,0x63,
    0x61,0x6c,0x65,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,0x66,0x66,0x73,0x65,0x74,
    0x28,0x63,0x31,0x32,0x2e,0x7a,0x29,0x3b,0x0a,0x7d,0x3b,0x0a,0x0a,0x0a,0x73,0x74,
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x32,0x20,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x3b,
    ...
    0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,
    ...
    ,
...
//    {
//        main0_out out = {};
//        out.gl_Position = ((_20.model * _20.view) * _20.projection) * float4(in.position, 0.0, 1.0);
//        float2 _51 = in.texture0 * _20.uv_scale;
//        out.uv = _51 + _20.uv_offset;
//        out.uv = _51 + (_20.uv_offset * _20.uv_scale);
//        return out;
//    }
//
//
const vs_source_metal_macos = [752]u8 {
    ...
    0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x26,0x20,0x5f,0x32,0x30,0x20,
    ...
    0x28,0x5f,0x32,0x30,0x2e,0x6d,0x6f,0x64,0x65,0x6c,0x20,0x2a,0x20,0x5f,0x32,0x30,
    0x2e,0x76,0x69,0x65,0x77,0x29,0x20,0x2a,0x20,0x5f,0x32,0x30,0x2e,0x70,0x72,0x6f,
    0x6a,0x65,0x63,0x74,0x69,0x6f,0x6e,0x29,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,
    ...
    ,
...
//
//    fn main_1() {
//      gl_Position = (((x_20.model * x_20.view) * x_20.projection) * vec4f(position_1.x, position_1.y, 0.0f, 1.0f));
//      let x_50 = x_20.uv_scale;
//      let x_51 = (texture0 * x_50);
//      let x_54 = x_20.uv_offset;
//      uv = (x_51 + x_54);
//      uv = (x_51 + (x_54 * x_50));
//      return;
//    }
...
const vs_source_wgsl = [1044]u8 {
    ...
    0x74,0x28,0x31,0x39,0x32,0x29,0x20,0x2a,0x2f,0x0a,0x20,0x20,0x75,0x76,0x5f,0x6f,
    0x66,0x66,0x73,0x65,0x74,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x2c,0x0a,0x20,
    0x20,0x2f,0x2a,0x20,0x40,0x6f,0x66,0x66,0x73,0x65,0x74,0x28,0x32,0x30,0x30,0x29,
    0x20,0x2a,0x2f,0x0a,0x20,0x20,0x75,0x76,0x5f,0x73,0x63,0x61,0x6c,0x65,0x20,0x3a,
    0x20,0x76,0x65,0x63,0x32,0x66,0x2c,0x0a,0x7d,0x0a,0x0a,0x40,0x62,0x69,0x6e,0x64,
    ...
    0x32,0x30,0x20,0x3a,0x20,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x3b,0x0a,
    ...
    0x3c,0x70,0x72,0x69,0x76,0x61,0x74,0x65,0x3e,0x20,0x74,0x65,0x78,0x74,0x75,0x72,
    0x65,0x30,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x3b,0x0a,0x0a,0x76,0x61,0x72,
    ...
    0x28,0x78,0x5f,0x32,0x30,0x2e,0x6d,0x6f,0x64,0x65,0x6c,0x20,0x2a,0x20,0x78,0x5f,
    0x32,0x30,0x2e,0x76,0x69,0x65,0x77,0x29,0x20,0x2a,0x20,0x78,0x5f,0x32,0x30,0x2e,
    0x70,0x72,0x6f,0x6a,0x65,0x63,0x74,0x69,0x6f,0x6e,0x29,0x20,0x2a,0x20,0x76,0x65,
    ...
    ,
    ...
    0x61,0x6d,0x3b,0x0a,0x20,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x20,0x3d,
    0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x30,0x5f,0x70,0x61,0x72,0x61,0x6d,0x3b,
