...
pub fn build(b: *std.Build) !void {
    ...
    const mod = b.addModule("marble_madness_zig", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "marble_madness_zig" is the name you will use in your source code to
                // import this module (e.g. `@import("marble_madness_zig")`). The name is
